    ...
    <div style={{ backgroundColor: "var(--whiteGray)" }}>
      <DetailSection>
        ...
        <DetailContents>
          ...
          <DetailPost>
            <VeiwCount>
              <S.StyledSpan14>veiw</S.StyledSpan14>
            </VeiwCount>
            ...
            <OptionSection>
              <CheckBox
                $bg={selectFrame}
                onMouseDown={() => setSelectFrame(!selectFrame)}
              >
                <span>프레임 사용하기</span>
                <input
                  type="checkbox"
              ...
              <CheckBox
                $bg={selectFilter}
                onMouseDown={() => setSelectFilter(!selectFilter)}
              >
                <span>필터 사용하기</span>
                <input
                  type="checkbox"
...
const CheckBox = styled.div`
  ...
  background-color: ${(props) =>
    props.$bg ? "var(--lightGreen)" : "var(--lightGray)"};
